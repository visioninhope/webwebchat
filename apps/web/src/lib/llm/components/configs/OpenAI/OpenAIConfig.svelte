...
<div class="space-y-20">
		...
		<div class="space-y-20">
			...
			<div>
				<div class="form-control mb-10">
					<div class="flex">
						<span class="label">
							...
							<button
								...
								type="button"
								on:click={() => {
									idbLLMConfig.config.configuration.baseURL =
					...
					<input
						bind:value={idbLLMConfig.config.configuration.baseURL}
						type="text"
	...
	<details>
		...
		<div class="form-control mb-10">
			...
			<PasswordInputWrapper bind:value={idbLLMConfig.config.openAIApiKey} />
		</div>
	</details>
</div>
